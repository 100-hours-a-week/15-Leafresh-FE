...
import { getGroupParticipationsCount } from '@entities/member/api/challenge/participate/get-group-participant-count'
import type { ChallengeStatus } from '@entities/member/api/challenge/participate/get-group-participant-list'
import { useInfiniteGroupParticipations } from '@features/challenge/api/group/participate/use-get-group-participant-list'
import ChallengeCard from '@features/challenge/components/challenge-participant-card/ui/challenge-participant-card'
