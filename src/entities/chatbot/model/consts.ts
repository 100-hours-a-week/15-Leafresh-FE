...
export const liveImages = [
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/beach.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/city.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/mountain.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/farm.jpg',
]

export const workImages = [
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/athome.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/sales.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/fieldwork.jpg',
  'https://storage.googleapis.com/leafresh-prod-images/init/chatbot/business.jpg',
]
