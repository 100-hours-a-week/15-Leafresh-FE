...
import { OngoingTimeDealCard } from '../../ongoing-timedeal-card/ui/ongoing-timedeal-card'
...
const OngoingTimeDealList = ({ data, className }: Props): ReactNode => {
  /** 각 재고의 남은 시간 트래킹 */
...
export default OngoingTimeDealList
