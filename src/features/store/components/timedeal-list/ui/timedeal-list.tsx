...
import OngoingTimeDealList from '../../ongoing-timedeal-list/ui/ongoing-timedeal-list'
import UpcomingTimeDealList from '../../upcoming-timedeal-list/ui/upcoming-timedeal-list'
