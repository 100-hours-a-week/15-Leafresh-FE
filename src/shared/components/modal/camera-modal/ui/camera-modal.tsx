...
import CheckIcon from '@shared/components/check-icon/ui/check-icon'
...
import SwitchTap from '../../../switchtap/ui/switch-tab'
import VerificationGuideModal from '../../verification-guide-modal/ui/verification-guide-modal'
